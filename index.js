...
const fetchData = async (page) => {
  try {
    await fetch(
      `https://api.unsplash.com/search/photos?page=${page}&per_page=40&query=cat&client_id=FEBrn4bNr40ww3u05nAb4Sw39lruknEZZFGrJu3Lqac`
    )
      .then((res) => res.json())
      .then((res) => {
...
async function searchCharacter() {
  ...
  let res = await fetch(
    `https://api.unsplash.com/search/photos?page=1&per_page=20&query=${query}&client_id=FEBrn4bNr40ww3u05nAb4Sw39lruknEZZFGrJu3Lqac`
  );
